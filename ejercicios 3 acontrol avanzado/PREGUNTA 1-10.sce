...
////// PREGUNTA 6 //////
// Controlabilidad y Observabilidad de la planta
...
// Valores singulares de la planta con  el  integrador //
sv2 = svplot(Gs_1,w1);
scf(5)
...
//POLOS Y CEROS DEL FILTRO DE KALMAN GANACIA H 
[h2]=ss2tf(Gs_3)
scf(8)
plzr(h2);
